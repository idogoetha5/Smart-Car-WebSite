...
const seeds: Seed[] = [
  ...
  ['change','שינוי הארכה','change extend','צריך לשנות את הבקשה','You need to change the request','נשמור את הפרטים ונעביר לטיפול, בלי לשנות הזמנה אוטומטית. לא יהיה צורך לחזור על הפרטים.','We’ll retain details and route this for handling; no booking changes are made automatically. You will not need to repeat the details.','מה מספר ההזמנה?','What is the booking reference?',false,true],
