        ...
        {isHe ? (
          <>
            ...
            <section>
              ...
              <p className="mt-2">האתר עומד בדרישות הנגישות החלות עליו. בוצעו בדיקות נגישות ידניות ואוטומטיות, לרבות בדיקות עבור שימוש על ידי אנשים עם לקויות ראייה. אנו פועלים באופן שוטף לשמירה על נגישות האתר ולשיפורה, בהתאם להתפתחות האתר והשירותים המוצעים בו. אם נתקלתם בקושי בשימוש באתר, נשמח לקבל את פנייתכם ולטפל בה בהקדם.</p>
          ...
          <>
            ...
            <section>
              ...
              <p className="mt-2">The website meets the accessibility requirements applicable to it. Manual and automated accessibility testing has been carried out, including testing for use by people with visual impairments. We continuously work to maintain and improve its accessibility as the website and its services evolve. If you encounter any accessibility difficulty while using the website, please contact us so we can address it promptly.</p>
