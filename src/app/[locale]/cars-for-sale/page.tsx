...
export default async function CarsForSalePage({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12" dir={isHe ? 'rtl' : 'ltr'}>
      <div className="mb-10">
        <div className="flex items-center gap-2 text-[#B64916] mb-3">
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a
              ...
              className="flex items-center gap-2 px-6 py-3 bg-[#178540] text-white font-bold rounded-xl hover:bg-[#1ebe5d] transition-colors text-lg"
            >
          ...
          {cars.map((car) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                {car.extras && (
                  <p className="text-sm text-gray-600 mb-4 line-clamp-2">{car.extras}</p>
                )}
