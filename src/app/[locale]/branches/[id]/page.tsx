...
const CONTENT: Record<BranchId, { metaHe: string; metaEn: string; bodyHe: string; bodyEn: string }> = {
  ...
  jerusalem: {
    ...
    bodyHe:
      'נהיגה בעיר העתיקה ובסמטאות מרכז ירושלים לא פשוטה, ולכן הסניף שלנו ברחוב המלך דוד, סמוך למתחם ממילא ולמלונות המרכזיים של העיר (מלון המלך דוד, מצודת דוד וימק"א), יושב במיקום שממנו קל לצאת לכביש 1 ולכבישים הראשיים בלי להיכנס לפקקים של מרכז העיר. השכרת רכב בירושלים מתאימה לתושבי העיר, לאנשי עסקים שמגיעים למרכז ולמוסדות הממשל, לתיירים ולעולי-רגל שרוצים לצאת ממנה לים המלח, לצפון או לכל מקום אחר בארץ, ולסטודנטים שצריכים רכב לתקופה קצרה. גם כאן תמצאו את הצי הרחב והשירות האישי שמאפיינים כל סניף של SmartCar.',
    bodyEn:
      'Driving through the Old City and downtown Jerusalem\'s narrow streets isn\'t simple, which is why our branch on King David Street, near the Mamilla complex and the city\'s central hotels (the King David Hotel, Citadel and YMCA), sits somewhere you can reach Route 1 and the main highways without fighting the city-center traffic. Car rental in Jerusalem works for city residents, business visitors heading to the government and institutional district, tourists and pilgrims continuing on to the Dead Sea or the north, and students who need a car for a short stretch. The same wide fleet and personal service you\'ll find at every SmartCar branch is here too.',
  },
  airport: {
    ...
    bodyHe:
      'נוחתים בנתב"ג ורוצים להתחיל לנסוע בלי לעמוד בתור למונית או לאוטובוס? שירות המשלוח שלנו לנמל התעופה עובד 24/7 — הרכב מגיע אליכם לטרמינל, ומהרגע הזה יש גישה מהירה לכבישים הראשיים לכל הארץ. השכרת רכב בנתב"ג מתאימה לתיירים שמגיעים לישראל בפעם הראשונה, לישראלים שחוזרים מחו"ל בלי רכב בבית, ולנוסעי עסקים שצריכים לזוז מהר — עם צי רכבים רחב מקומפקטי ועד יוקרה, ושירות אישי שמלווה את SmartCar כבר משנת 2003. אפשר גם לאסוף רכב מכל מקום בארץ ולהחזיר אותו כאן בנתב"ג, וכמובן גם לאסוף ולהחזיר בנתב"ג לכל אורך הטיול — נוח מאוד אם אתם צריכים רכב גדול כבר מהנחיתה ועד היום שאתם עוזבים.',
    bodyEn:
      'Landing at Ben Gurion Airport and want to get moving without waiting in the taxi or bus line? Our airport delivery service runs 24/7 — your car is brought straight to the terminal, and from there it\'s a quick run onto the main highways to anywhere in the country. Car rental at Ben Gurion works for first-time visitors to Israel, returning residents without a car at home, and business travelers who need to move fast — with a fleet from compact to luxury and the personal service SmartCar has offered since 2003. You can also pick up your car anywhere in the country and return it here at the airport, or pick up and return it here for the whole trip — ideal if you need a larger vehicle from the moment you land until the day you leave.',
  },
};
