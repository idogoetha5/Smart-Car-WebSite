...
const CONTENT: Record<BranchId, { metaHe: string; metaEn: string; bodyHe: string; bodyEn: string }> = {
  ...
  jerusalem: {
    ...
    bodyHe:
      'נהיגה בעיר העתיקה ובסמטאות מרכז ירושלים לא פשוטה, ולכן הסניף שלנו ברחוב המלך דוד, סמוך למתחם ממילא ולמלונות המרכזיים של העיר (מלך דוד, מצודת דוד וימק"א), יושב במיקום שממנו קל לצאת לכביש 1 ולכבישים הראשיים בלי להיכנס לפקקים של מרכז העיר. השכרת רכב בירושלים מתאימה לתושבי העיר, לאנשי עסקים שמגיעים למרכז ולמוסדות הממשל, לתיירים ולעולי-רגל שרוצים לצאת ממנה לים המלח, לצפון או לכל מקום אחר בארץ, ולסטודנטים שצריכים רכב לתקופה קצרה. גם כאן תמצאו את הצי הרחב והשירות האישי שמאפיינים כל סניף של SmartCar.',
    bodyEn:
      'Driving through the Old City and downtown Jerusalem\'s narrow streets isn\'t simple, which is why our branch on King David Street, near the Mamilla complex and the city\'s central hotels (King David, Citadel and YMCA), sits somewhere you can reach Route 1 and the main highways without fighting the city-center traffic. Car rental in Jerusalem works for city residents, business visitors heading to the government and institutional district, tourists and pilgrims continuing on to the Dead Sea or the north, and students who need a car for a short stretch. The same wide fleet and personal service you\'ll find at every SmartCar branch is here too.',
  },
  airport: {
