...
export default function CatalogPage() {
  ...
  const { vehicles, isLoading, filters, setFilters } = useVehicles({});
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" dir={locale === 'he' ? 'rtl' : 'ltr'}>
      <div className="mb-8">
        ...
        <p className="text-gray-500">{filtered.length} {locale === 'he' ? 'רכבים' : 'vehicles'}</p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <aside className="lg:w-72 shrink-0">
          <div className="sticky top-24">
            <VehicleFiltersPanel filters={filters} onChange={setFilters} />
          </div>
        </aside>
