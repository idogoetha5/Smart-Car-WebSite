...
const SERVICES: Record<string, ServiceData> = {
  business: {
    ...
    featuresHe: ['חשבוניות מע"מ מסודרות', 'מחירים מיוחדים לעסקים', 'ניהול צי לעסקים', 'גמישות בביטול בהתאם לתנאים', 'רכבים זמינים 24/7', 'שירות אישי לחשבון עסקי'],
    featuresEn: ['VAT invoices', 'Special business pricing', 'Fleet management', 'Cancellation flexibility per terms', 'Vehicles available 24/7', 'Personal account manager'],
    cta: [
  ...
  'new-driver': {
    ...
    descHe: 'השכרת רכב זמינה מגיל 18, גם לנהגים שטרם צברו שנתיים ותק. כל נהג חייב להחזיק ברישיון נהיגה תקף, להירשם מראש בחוזה ההשכרה ולהיות מכוסה בכיסוי הביטוחי המתאים. הנהיגה כפופה למגבלות החלות על הנהג לפי גילו והוותק שלו.',
    descEn: 'Rental is available from age 18, including drivers who have not yet completed two years of licence seniority. Every driver must hold a valid driving licence, be registered in the rental agreement in advance, and be covered by the applicable insurance. Driving is subject to the restrictions that apply to the driver by age and seniority.',
    featuresHe: ['השכרה מגיל 18', 'רישיון נהיגה בתוקף', 'רישום הנהג בחוזה ההשכרה מראש', 'כיסוי ביטוחי מתאים לנהג', 'רכבים קלים ובטוחים לנהיגה', 'ייעוץ אישי לבחירת הרכב הנכון'],
    featuresEn: ['Available from age 18', 'Valid driving licence', 'Driver registered in the rental agreement in advance', 'Applicable insurance cover for the driver', 'Easy and safe vehicles to drive', 'Personal advice for choosing the right car'],
    cta: [
  ...
  leasing: {
    ...
    descHe: 'ליסינג פרטי ועסקי עם תנאים גמישים לכל תקציב. חוזים ל-12 עד 60 חודשים, תחזוקה כלולה, ותנאים ברורים מראש. פתרון גמיש לטווח ארוך.',
    descEn: 'Private and business leasing with flexible terms for every budget. Contracts from 12 to 60 months, maintenance included, and clear terms upfront. A flexible long-term solution.',
    featuresHe: ['חוזים גמישים 12-60 חודשים', 'תחזוקה שוטפת כלולה', 'ביטוח מקיף אופציונלי', 'החלפת רכב בסיום חוזה', 'ייתכנו הטבות מס לעצמאים (בכפוף לייעוץ)', 'מגוון רכבים לבחירה'],
    featuresEn: ['Flexible contracts 12–60 months', 'Ongoing maintenance included', 'Optional comprehensive insurance', 'Vehicle swap at contract end', 'Possible tax benefits for the self-employed (subject to advice)', 'Wide vehicle selection'],
    cta: [
