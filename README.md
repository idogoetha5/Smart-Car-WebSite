...
|---|---|---|---|
| שמונת האייקונים בסקשן „כל סוגי ההשכרה” | `src/components/home/HeroSection.tsx` | נוצרו לפרויקט הזה | — |
| `lucide-react` | אייקוני ממשק, כולל כפתור הנגישות | [Lucide](https://lucide.dev) | ISC |

שמונת האייקונים בסקשן „כל סוגי ההשכרה” הם משפחה אחת ומשותפים למסגרת
`ServiceIcon` שבאותו קובץ. אין להוסיף לאף אחד מהם מאפיינים משלו — המסגרת
קובעת `viewBox`, גודל, צבע, עובי קו וקצוות, וה-`fit` שלכל אייקון ממרכז ומקנה-מידה
את הציור לתיבה משותפת.
